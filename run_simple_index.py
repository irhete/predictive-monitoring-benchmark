...
outfile = "results_simple_index_bpic2011.csv"
...
pos_label = "deviant"
neg_label = "regular"
dynamic_cols = [] # i.e. event attributes
static_cols = [] # i.e. case attributes that are known from the start
...
with open(outfile, 'w') as fout:
    for dataset_name, data_filepath in datasets.items():
        ...
        for nr_events in prefix_lengths:
            ...
            X = tmp.drop([label_col, case_id_col], axis=1)
            y = tmp[label_col]
